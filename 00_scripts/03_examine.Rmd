---
title: Tipping Bucket Rain Gauge QAQC Report for  `r location_keyword_i`, `r examineYear `
date: "`r Sys.Date()`"
output: 
  html_document:
    toc: true
...
Below shows a heatmap for hourly rain `r data_type_all[[2]]` data.  
...
This table shows the data for goodness-of-fit evaluation, location `r location_keyword_i`, year `r examineYear`.   
